        ...
        <div className={'row'}>
            ...
            <div className={'col-lg-4 text-right-images'}>
                <div className={'footer-images'}>
                    <img className={'d-inline-block logo-1'} src={require('./../../assets/images/917bd5698f9b74b38081440b9eff12dc.png').default} />
                    <img className={'d-inline-block logo-2'} src={require('./../../assets/images/7c77a5a22ea47f2a489591985fa8736a.jpg').default} />
                </div>
            </div>
        </div>
    </div>
